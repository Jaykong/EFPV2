...
fileprivate final class Connection<S: SubjectType>: ObserverType, Disposable {
...
fileprivate final class ConnectableObservableAdapter<S: SubjectType>
...
fileprivate final class RefCountSink<CO: ConnectableObservableType, O: ObserverType>
    : Sink<O>
...
fileprivate final class RefCount<CO: ConnectableObservableType>: Producer<CO.E> {
    fileprivate let _lock = RecursiveLock()
...
fileprivate final class MulticastSink<S: SubjectType, O: ObserverType>: Sink<O>, ObserverType {
    typealias Element = O.E
...
fileprivate final class Multicast<S: SubjectType, R>: Producer<R> {
