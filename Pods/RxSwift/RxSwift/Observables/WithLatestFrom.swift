...
fileprivate final class WithLatestFromSink<FirstType, SecondType, O: ObserverType>
    : Sink<O>
    , ObserverType
    , LockOwnerType
    , SynchronizedOnType {
...
fileprivate final class WithLatestFromSecond<FirstType, SecondType, O: ObserverType>
    : ObserverType
    , LockOwnerType
    , SynchronizedOnType {
...
fileprivate final class WithLatestFrom<FirstType, SecondType, ResultType>: Producer<ResultType> {
