...
fileprivate final class TakeCountSink<O: ObserverType>: Sink<O>, ObserverType {
    typealias E = O.E
...
fileprivate final class TakeCount<Element>: Producer<Element> {
...
fileprivate final class TakeTimeSink<ElementType, O: ObserverType>
    : Sink<O>
    , LockOwnerType
    , ObserverType
...
fileprivate final class TakeTime<Element>: Producer<Element> {
