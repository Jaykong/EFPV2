...
fileprivate final class SwitchIfEmpty<Element>: Producer<Element> {
...
fileprivate final class SwitchIfEmptySink<O: ObserverType>: Sink<O>
    , ObserverType {
    typealias E = O.E
...
fileprivate final class SwitchIfEmptySinkIter<O: ObserverType>
    : ObserverType {
    typealias E = O.E
