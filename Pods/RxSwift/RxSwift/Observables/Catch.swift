...
fileprivate final class CatchSink<O: ObserverType>: Sink<O>, ObserverType {
    typealias E = O.E
...
fileprivate final class Catch<Element>: Producer<Element> {
...
fileprivate final class CatchSequenceSink<S: Sequence, O: ObserverType>
