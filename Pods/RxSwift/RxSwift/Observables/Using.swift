...
fileprivate final class UsingSink<ResourceType: Disposable, O: ObserverType>: Sink<O>, ObserverType {
...
fileprivate final class Using<SourceType, ResourceType: Disposable>: Producer<SourceType> {
