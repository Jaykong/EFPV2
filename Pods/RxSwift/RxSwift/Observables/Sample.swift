...
fileprivate final class SamplerSink<O: ObserverType, SampleType>
    : ObserverType
    , LockOwnerType
    , SynchronizedOnType {
...
fileprivate final class SampleSequenceSink<O: ObserverType, SampleType>
    : Sink<O>
    , ObserverType
    , LockOwnerType
    , SynchronizedOnType {
...
fileprivate final class Sample<Element, SampleType>: Producer<Element> {
