...
fileprivate final class MergeLimited<SourceSequence: ObservableConvertibleType>: Producer<SourceSequence.E> {
...
fileprivate final class MergeArray<Element>: Producer<Element> {
