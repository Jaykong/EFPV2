...
fileprivate final class DelaySink<O: ObserverType>
    : Sink<O>
    , ObserverType {
    typealias E = O.E
    ...
    func drainQueue(state _: (), scheduler: AnyRecursiveScheduler<()>) {
...
fileprivate final class Delay<Element>: Producer<Element> {
