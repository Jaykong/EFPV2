...
fileprivate final class SkipUntilSinkOther<Other, O: ObserverType>
    : ObserverType
    , LockOwnerType
    , SynchronizedOnType {
...
fileprivate final class SkipUntilSink<Other, O: ObserverType>
    : Sink<O>
    , ObserverType
    , LockOwnerType
    , SynchronizedOnType {
...
fileprivate final class SkipUntil<Element, Other>: Producer<Element> {
