...
import UIKit
import NSObject_Rx
class EFPSessionSearchRecordViewController: UIViewController, BindableViewType, EFPTableViewProtocol {
    var tableView: UITableView = UITableView()
    var viewModel: SearchRecordViewModel!

    func bindViewModel() {

    }

    typealias ViewModelType = SearchRecordViewModel
    ...
    fileprivate func setupRecentSearchRecordTableViewDatasource() {
        ...
        let searchResultViewModel = SearchRecordViewModel()
    ...
    override func viewDidLoad() {
        ...
        Observable.zip(tableView.rx.itemSelected, tableView.rx.modelSelected(String.self)) .bind
        { (indexPath, model) in
